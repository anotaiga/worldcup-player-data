...
<div class="table-container">
    <form method="GET" action="{{ route('player.update', ['player_id' => $player->id]) }}">
        <table border="3" >
            
        <tr>
                <th>No</th>
                <td name="id">{{ $player->id }}
            ...
            <tr>
                ...
                <td>
                    ...
                    @endif
                    <input type="text" style="width:300px;" name="uniform_num" value="{{ $player->uniform_num }}">
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    ...
                    @endif
                    <input type="text" style="width:300px;" name="name" value="{{ $player->name }}">
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    ...
                    @endif
                    <input type="text" style="width:300px;" name="club" value="{{ $player->club }}">    
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    ...
                    @endif
                    <input type="date" name="birth" style="width:300px;" value="{{ $player->birth }}" min="1900-01-01" max="2014-7-13">
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    ...
                    @endif
                    <input type="text" style="width:300px;" name="height" value="{{ $player->height }}">
                </td>
            </tr>
            
            <tr>
                <th>体重</th>
                <td>@if($errors->has('weight'))
                        <div class="error-message">{{ $errors->first('weight') }}</div>
                    @endif
                    <input type="text" style="width:300px;" name="weight" value="{{ $player->weight }}">
                </td>
            </tr>
